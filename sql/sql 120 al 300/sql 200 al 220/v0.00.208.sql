/*    Viernes, 08 de Junio de 2.007   -   v0.00.208.sql 

	Actualizamos levemente el view qListadoComprobantesRetencion
...
WHERE     (dbo.MovimientosBancarios.Tipo = N'CH' OR
                      dbo.MovimientosBancarios.Tipo = N'ND')
...
Insert Into tVersion (VersionActual, Fecha) Values('v0.00.208', GetDate()) 