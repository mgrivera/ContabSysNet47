/*    Miercoles, 17 de Octubre de 2.005   -   v0.00.184.sql 

	Tabla Vacaciones: agregamos los items AplicarDeduccionesFlag y 
	AplicarNDeducciones 
...
SELECT     ClaveUnica, Empleado, GrupoNomina, TipoNomina, FechaIngreso, AnosServicio, SalarioPromedio, SueldoBasico, AnoVacaciones, NumeroVacaciones, 
                      ...
                      AplicarDeduccionesFlag, AplicarNDeducciones, Cia
FROM         dbo.Vacaciones
...
SELECT     dbo.Vacaciones.Empleado, dbo.Vacaciones.GrupoNomina, dbo.tGruposEmpleados.NombreGrupo, dbo.tEmpleados.Nombre AS NombreEmpleado, 
                      ...
                      dbo.Vacaciones.AplicarNDeducciones, dbo.Vacaciones.Cia
...
Insert Into tVersion (VersionActual, Fecha) Values('v0.00.184', GetDate()) 