/*    Lunes, 29 de Agosto de 2.005   -   v0.00.180c.sql 

	Agregamos algunos otros items a la tabla Vacaciones 
...
Insert Into tVersion (VersionActual, Fecha) Values('v0.00.180c', GetDate()) 