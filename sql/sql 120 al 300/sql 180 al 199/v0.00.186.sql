/*    Viernes, 26 de Octubre de 2.005   -   v0.00.186.sql 

	Tabla Vacaciones: agregamos el item CantDiasVacPendAnosAnteriores a 
	la tabla Vacaciones 
...
SELECT     ClaveUnica, Empleado, GrupoNomina, TipoNomina, FechaIngreso, AnosServicio, SalarioPromedio, SueldoBasico, AnoVacaciones, NumeroVacaciones, 
                      ...
                      CantDiasAnticipo, CantDiasBono, CantDiasAdicionales, CantDiasFeriados, CantDiasVacPendAnosAnteriores, CantDiasVacSegunTabla, 
                      CantDiasVacDisfrutadosAntes, CantDiasVacDisfrutadosAhora, CantDiasVacPendientes, AdelantoSueldoFlag, BonoVacacionalFlag, 
                      DesactivarNominaDesde, DesactivarNominaHasta, AplicarDeduccionesFlag, AplicarNDeducciones, DescontarSueldoFlag, 
                      DescontarSueldoCantidadDias, DescontarSueldoFechaNomina, Cia
FROM         dbo.Vacaciones
...
SELECT     dbo.Vacaciones.Empleado, dbo.Vacaciones.GrupoNomina, dbo.tGruposEmpleados.NombreGrupo, dbo.tEmpleados.Nombre AS NombreEmpleado, 
                      ...
                      dbo.Vacaciones.CantDiasVacPendAnosAnteriores, dbo.Vacaciones.CantDiasVacSegunTabla, dbo.Vacaciones.CantDiasVacDisfrutadosAntes, 
                      ...
                      dbo.Vacaciones.AplicarDeduccionesFlag, dbo.Vacaciones.AplicarNDeducciones, dbo.Vacaciones.DescontarSueldoFlag, 
                      dbo.Vacaciones.DescontarSueldoCantidadDias, dbo.Vacaciones.DescontarSueldoFechaNomina, dbo.Vacaciones.Cia
...
Insert Into tVersion (VersionActual, Fecha) Values('v0.00.186', GetDate()) 