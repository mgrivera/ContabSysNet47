/*    Martes, 13 de Julio de 2.004   -   v0.00.160.sql 

	Agregamos el item NumeroControl a la tabla Facturas. 
...
AS
SELECT     ClaveUnica, Proveedor, NumeroFactura, NumeroControl, ConsecutivoMes, Tipo, CondicionesDePago, FechaEmision, FechaRecepcion, Concepto, MontoFactura, IvaPorc, 
                      Iva, TotalFactura, MontoSujetoARetencion, ImpuestoRetenidoPorc, ImpuestoRetenido, RetencionSobreIvaPorc, RetencionSobreIva, TotalAPagar, Saldo, 
...
SELECT     dbo.Facturas.ClaveUnica, dbo.Facturas.Proveedor, dbo.Proveedores.Nombre AS NombreProveedor, dbo.Facturas.NumeroFactura, 
                      dbo.Facturas.NumeroControl, dbo.Facturas.ConsecutivoMes, dbo.Facturas.CondicionesDePago, dbo.Facturas.Tipo, dbo.TiposProveedor.Descripcion AS NombreTipo, 
...
Insert Into tVersion (VersionActual, Fecha) Values('v0.00.160', GetDate()) 
