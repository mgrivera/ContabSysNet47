/*    Martes, 20 de Septiembre de 2.011  -   v0.00.283.sql 

	Eliminamos la tabla AsientosClaveUnicaID; además, 
	convertimos la columna NumeroAutomatico, en Asientos, a Identity 
*/
...
Insert Into tVersion(VersionActual, Fecha) Values('v0.00.283', GetDate()) 