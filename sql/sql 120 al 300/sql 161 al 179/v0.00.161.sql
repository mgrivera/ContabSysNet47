/*    Martes, 13 de Julio de 2.004   -   v0.00.161.sql 

	Agregamos el item MontoFacturaSinIva  a la tabla Facturas. Además, cambiamos el nombre
	del item MontoFactura a MontoFacturaConIva. 
...
AS
SELECT     ClaveUnica, Proveedor, NumeroFactura, NumeroControl, ConsecutivoMes, Tipo, CondicionesDePago, FechaEmision, FechaRecepcion, Concepto, 
                      IvaPorc, MontoFacturaSinIva, MontoFacturaConIva, Iva, TotalFactura, MontoSujetoARetencion, ImpuestoRetenidoPorc, ImpuestoRetenido, 
                      RetencionSobreIvaPorc, RetencionSobreIva, TotalAPagar, Saldo, Estado, ImportacionFlag, Comprobante, CxCCxPFlag, Moneda, 
...
SELECT     dbo.Facturas.ClaveUnica, dbo.Facturas.Proveedor, dbo.Proveedores.Nombre AS NombreProveedor, dbo.Facturas.NumeroFactura, 
                      dbo.Facturas.NumeroControl, dbo.Facturas.ConsecutivoMes, dbo.Facturas.CondicionesDePago, dbo.Facturas.Tipo, 
...
Insert Into tVersion (VersionActual, Fecha) Values('v0.00.161', GetDate()) 
