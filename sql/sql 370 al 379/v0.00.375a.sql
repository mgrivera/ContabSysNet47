/*    Lunes, 27 de Abril de 2.015 	-  v0.00.375a.sql 

	Eliminamos NumeroContrato de Bancos y agregamos a CuentasBancarias 
*/
...
IF EXISTS(SELECT * FROM dbo.CuentasBancarias)
	 EXEC('INSERT INTO dbo.Tmp_CuentasBancarias (CuentaInterna, Agencia, CuentaBancaria, Tipo, Moneda, LineaCredito, Estado, CuentaContable, CuentaContableGastosIDB, FormatoImpresionCheque, GenerarTransaccionesAOtraCuentaFlag, CuentaBancariaAsociada, NombrePlantillaWord, NumeroDefinicion_ArchivoMovBanco, Cia)
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.375a', GetDate()) 