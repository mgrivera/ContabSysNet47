/*    
	  Viernes, 28/Dic/2.018  -   v0.00.409.sql 
	  
	  Agregamos la columna NatJurFlag a la tabla tTempWebReport_ConsultaFacturas 
*/
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.409', GetDate()) 
