/*    
	  Martes, 25/Jul/2.017   -   v0.00.400.sql 
	  Agregamos el nuevo campo 'CierreContabPermitirAsientosDescuadrados' a la tabla ParametrosContab 
*/
...
CREATE TABLE dbo.Tmp_ParametrosContab
	...
	CierreContabPermitirAsientosDescuadrados bit NULL,
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.400', GetDate()) 
