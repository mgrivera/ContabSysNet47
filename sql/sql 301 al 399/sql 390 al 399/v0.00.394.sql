/*    
	  Lunes, 01/May/2.017   -   v0.00.394.sql 

	  tTempWebReport_ConsultaFacturas: aumentamos el tamaño de la columna CodigoConceptoRetencion 
*/
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.394', GetDate()) 
