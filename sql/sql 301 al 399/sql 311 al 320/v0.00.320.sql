/*    Miércoles, 29 de Agosto de 2.012  -   v0.00.320.sql 
...
IF EXISTS(SELECT * FROM dbo.tEmpleados)
	 EXEC('INSERT INTO dbo.Tmp_tEmpleados (Empleado, Cedula, Rif, EscribirArchivoXMLRetencionesISLR, Status, Nombre, EdoCivil, Sexo, Nacionalidad, FechaNacimiento, CiudadOrigen, DireccionHabitacion, Telefono1, Telefono2, SituacionActual, Departamento, Cargo, FechaIngreso, FechaRetiro, BancoDepositosNomina, TipoCuentaDepositosNomina, CuentaBancariaDepositosNomina, BancoCuentaPrestacionesSociales, NumeroCuentaBancariaPrestacionesSociales, Contacto1, Parentesco1, TelefonoCon1, Contacto2, Parentesco2, TelefonoCon2, Contacto3, Parentesco3, TelefonoCon3, EmpleadoObreroFlag, SueldoPromedio, SueldoBasico, MontoCestaTickets, BonoVacAgregarSueldoFlag, BonoVacAgregarMontoCestaTicketsFlag, BonoVacacionalMontoAdicional, BonoVacAgregarMontoAdicionalFlag, Cia)
		SELECT Empleado, Cedula, Rif, EscribirArchivoXMLRetencionesISLR, Status, Nombre, EdoCivil, Sexo, Nacionalidad, FechaNacimiento, CiudadOrigen, DireccionHabitacion, Telefono1, Telefono2, SituacionActual, Departamento, Cargo, FechaIngreso, FechaRetiro, Banco, TipoCuenta, CuentaBancaria, BancoCuentaPrestacionesSociales, NumeroCuentaBancariaPrestacionesSociales, Contacto1, Parentesco1, TelefonoCon1, Contacto2, Parentesco2, TelefonoCon2, Contacto3, Parentesco3, TelefonoCon3, EmpleadoObreroFlag, SueldoPromedio, SueldoBasico, MontoCestaTickets, BonoVacAgregarSueldoFlag, BonoVacAgregarMontoCestaTicketsFlag, BonoVacacionalMontoAdicional, BonoVacAgregarMontoAdicionalFlag, Cia FROM dbo.tEmpleados WITH (HOLDLOCK TABLOCKX)')
GO
...
alter table tEmpleados alter column Telefono1 nvarchar(25) null 
alter table tEmpleados alter column Telefono2 nvarchar(25) null 
alter table tEmpleados alter column TelefonoCon1 nvarchar(25) null 
alter table tEmpleados alter column TelefonoCon2 nvarchar(25) null 
alter table tEmpleados alter column TelefonoCon3 nvarchar(25) null 
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.320', GetDate()) 