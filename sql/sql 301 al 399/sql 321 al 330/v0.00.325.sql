/*    Miércoles, 12 de 2.012  -   v0.00.325.sql 

	Aumentamos la capacidad del nombre del proveedor, en la tabla Proveedores 
*/
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.325', GetDate()) 