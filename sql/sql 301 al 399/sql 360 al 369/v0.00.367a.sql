/*    Miércoles, 22 de Enero de 2.014 	-   v0.00.367a.sql 
...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.Vacaciones ADD
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.367a', GetDate()) 
