/*    Jueves, 28 de Noviembre de 2.013 	-   v0.00.363.sql 

	Agregamos las columnas email y Alias a la tabla de Empleados 
...
Update tEmpleados Set Alias = Substring(Replace(Replace(LTrim(RTrim(Nombre)), ' ', ''), ',', ''), 0, 15)
Alter Table tEmpleados Alter Column Alias nvarchar(15) Not Null
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.363', GetDate()) 
