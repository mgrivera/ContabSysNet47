/*    
	  Martes, 6/Dic/2016   -   v0.00.384.sql 

	  Agregamos la columna TipoAlicuota_XXX a la tabla tTempWebReport_ConsultaFactura
*/
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.384', GetDate()) 
