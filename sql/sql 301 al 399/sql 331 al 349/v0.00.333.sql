/*    Miercoles, 6 de Marzo de 2.013  -   v0.00.333.sql 

	Hacemos cambios leves a la tabla tTempWebReport_ConsultaFacturas 
*/


/****** Object:  Table [dbo].[tTempWebReport_ConsultaFacturas]    Script Date: 03/06/2013 17:46:59 ******/
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.333', GetDate()) 