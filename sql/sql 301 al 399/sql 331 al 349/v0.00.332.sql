/*    Viernes, 22 de Febrero de 2.013  -   v0.00.332.sql 

	Hacemos cambios leves a la tabla tTempWebReport_ConsultaFacturas 
*/


/****** Object:  Table [dbo].[tTempWebReport_ConsultaFacturas]    Script Date: 02/22/2013 09:52:24 ******/
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.332', GetDate()) 