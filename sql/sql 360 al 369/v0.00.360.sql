/*    Lunes, 21 de Octubre de 2.013 	-   v0.00.360.sql 

	Agregamos el item Tipo a la tabla de días feriados 
*/
...
BEGIN TRANSACTION
GO
ALTER TABLE dbo.DiasFeriados ADD Tipo tinyint NULL
GO
ALTER TABLE dbo.DiasFeriados SET (LOCK_ESCALATION = TABLE)
GO
COMMIT

Update DiasFeriados Set Tipo = 0 
ALTER TABLE dbo.DiasFeriados Alter Column Tipo smallint Not NULL


-- para agrandar el nombre del proveedor en esta tabla (vencimientos de facturas) 

Alter Table Bancos_VencimientoFacturas Alter Column NombreCompania nvarchar(70) NOT NULL
...
GO
ALTER TABLE dbo.ParametrosNomina ADD CONSTRAINT
	FK_ParametrosNomina_tMaestraRubros3 FOREIGN KEY
	(
	RubroBonoVacacional
	) REFERENCES dbo.tMaestraRubros
	(
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.360', GetDate()) 
