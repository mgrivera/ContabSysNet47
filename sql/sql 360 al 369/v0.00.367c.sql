/*    Viernes, 31 de Enero de 2.014 	-   v0.00.367c.sql 

	Agregamos la columna TipoNomina a la tabla de empleados; además, 
	agregamos la columna Detalles a la tabla de nómina ... 

	Nota importante: al final, actualizar este item con: 
				 1 nómina quincenal; 2 nómina mensual
				 
	(buscar esta instrucción más adelante ...  Update tEmpleados Set TipoNomina = 1
	 y establecer el tipo de nómina que nómina usan los empleados) 
*/
...
Update tEmpleados Set TipoNomina = 1 
Alter TABLE tEmpleados alter column TipoNomina smallint Not NULL
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.367c', GetDate()) 
