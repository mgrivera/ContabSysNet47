/*    
	  Martes, 26 de Noviembre de 2.019  -   v0.00.419.sql 
	  
	  Agregamos la columna moneda a la tabla de registro de activos fijos 
*/
...
CREATE TABLE dbo.Tmp_InventarioActivosFijos
	...
	Moneda int NULL,
	Producto nvarchar(15) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	Tipo int NOT NULL,
	Departamento int NOT NULL,
	Descripcion nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
	CompradoA nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	Proveedor int NULL,
	Serial nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	Modelo nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	Placa nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	Factura nvarchar(255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
	...
	MotivoDesincorporacion ntext COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
Update InventarioActivosFijos Set Moneda = 1 

Alter Table InventarioActivosFijos Alter Column Moneda int Not NULL
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.419', GetDate()) 
