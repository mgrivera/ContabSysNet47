/*    
	  Viernes, 24 de Junio de 2.016	-   v0.00.382.sql 

	  Hacemos un cambio muy leve al stored procedure BalanceGeneral; este sp no sumaba los saldos de una cuenta 
	  cuendo la contabilidad es multimoneda; estas contabilidades tienen, normalmene, más de un registro en esta 
	  tabla (SaldosContables) para una misma moneda; ejemplo: 'bs-bs' y 'bs-$' ... 
*/


/****** Object:  StoredProcedure [dbo].[spBalanceGeneral]    Script Date: 24/06/2016 11:18:30 a.m. ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	begin
		...
		-- Obviamos asientos contables de tipo cierre anual, si el usuario así lo indicó al requerir la consulta 
	...
	/* TODO: obviar asientos del tipo Cierre Anual, si así lo indicó el usaurio al solicitar la consulta ...  */ 
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.382', GetDate()) 
