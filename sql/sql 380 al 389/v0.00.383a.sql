/*    
	  Viernes, 14 de Octubre de 2.016	-   v0.00.383a.sql 

	  Hacemos un cambio muy leve al stored procedure spBalanceGeneral; eliminamos la funcionalidad 
	  que permitía que el periodo para la consulta comenzara con un día posterior al 1ro. 
*/


/****** Object:  StoredProcedure [dbo].[spBalanceGeneral]    Script Date: 14/10/2016 05:52:39 p.m. ******/
SET ANSI_NULLS ON
GO
...
Insert Into tVersionWeb(VersionActual, Fecha) Values('v0.00.383a', GetDate()) 
