<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage_Simple.master" AutoEventWireup="true" Inherits="Contab_Presupuesto_Consultas_Mensual_ConsultaPresupuesto_ConsultaMovAcum" Codebehind="ConsultaPresupuesto_ConsultaMovAcum.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:ListView ID="MovimientosContables_ListView" 
                  runat="server" 
                    ...
                    <td id="Td1" runat="server">
                        <table ID="itemPlaceholderContainer" runat="server" border="0" style="border: 1px solid #E6E6E6"
                            ...
                            <tr ID="itemPlaceholder" runat="server">
                             ...
                             <tr id="Tr4" runat="server" style="background-position: #E1ECF9; background: #E1ECF9; color: #000000;" class="ListViewHeader_Suave">
                                <th id="Th8" runat="server" class="padded" style="text-align: center; padding-top: 4px; padding-bottom: 4px; ">
                                    </th>
                                <th id="Th9" runat="server" class="padded" style="text-align: center; padding-top: 4px; padding-bottom: 4px; ">
                                    </th>
                                <th id="Th10" runat="server" class="padded" style="text-align: left; padding-top: 4px; padding-bottom: 4px; ">
                                    </th>
                                <th id="Th11" runat="server" class="padded" style="text-align: left; padding-top: 4px; padding-bottom: 4px; ">
                                    </th>
                                <th id="Th12" runat="server" class="padded" style="text-align: left; padding-top: 4px; padding-bottom: 4px; ">
                                    </th>
                                <th id="Th13" runat="server" class="padded" style="text-align: left; padding-top: 4px; padding-bottom: 4px; ">
                                    Total:</th>
                                <th id="Th14" runat="server" class="padded" style="text-align: right; padding-top: 4px; padding-bottom: 4px; ">
    ...
    ConnectionString="<%$ ConnectionStrings:dbContabConnectionString %>" 
        ...
        SelectCommand="SELECT Asientos.Fecha, Asientos.Numero, CuentasContables.CuentaEditada, 
        CuentasContables.Descripcion AS NombreCuentaContable, dAsientos.Descripcion AS DescripcionAsiento, 
        dAsientos.Referencia, CASE WHEN dAsientos.Haber &lt;&gt; 0 THEN dAsientos.Haber * -1 ELSE 
        dAsientos.Debe END AS Monto FROM dAsientos Inner Join Asientos On dAsientos.NumeroAutomatico = Asientos.NumeroAutomatico 
        INNER JOIN CuentasContables ON 
        dAsientos.CuentaContableID = CuentasContables.ID INNER JOIN 
        Presupuesto_AsociacionCodigosCuentas ON CuentasContables.ID = 
        Presupuesto_AsociacionCodigosCuentas.CuentaContableID 
        WHERE (Asientos.MesFiscal &lt;= @MesFiscal) AND 
        (Asientos.AnoFiscal = @AnoFiscal) AND (Asientos.Moneda = @Moneda) AND (Asientos.Cia = @CiaContab) 
        AND (Presupuesto_AsociacionCodigosCuentas.CodigoPresupuesto = @CodigoPresupuesto) AND 
        (Presupuesto_AsociacionCodigosCuentas.CiaContab = @CiaContab) Order By 
        Asientos.Fecha, CuentasContables.Cuenta">
        <SelectParameters>
