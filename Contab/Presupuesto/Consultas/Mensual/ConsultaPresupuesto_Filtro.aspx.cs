...
public partial class Contab_Presupuesto_Consulta_Mensual_ConsultaPresupuesto_Filtro : System.Web.UI.Page
{
    ...
    protected void AplicarFiltro_Button_Click(object sender, EventArgs e)
    {
        ...
        // este es el mes calendario que el usuario desea consultar 
        Session["ConsultaPresupuesto_MesCalendario"] = Meses_ListBox.SelectedValue; 
    ...
    {
        args.IsValid = (Meses_ListBox.SelectedIndex >= 0);
    }
