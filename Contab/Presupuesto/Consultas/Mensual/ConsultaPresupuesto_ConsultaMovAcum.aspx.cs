...
public partial class Contab_Presupuesto_Consultas_Mensual_ConsultaPresupuesto_ConsultaMovAcum : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Master.Page.Title = "Consulta de presupuesto  -  consulta de movimientos contables para un código de presupuesto acumulados hasta un mes";
        ...
        if (!Page.IsPostBack)
        {
            ...
            TituloConsulta_H2.InnerHtml = "Movimientos contables para el código de presupuesto " +
                            ...
                            "acumulados hasta el mes " + MyMesesAnoFiscal.NombreMes + " del año fiscal " + Request.QueryString["AnoFiscal"].ToString();

            // usamos linq to sql para obtener un total de los movimientos seleccionados y mostrados 

            decimal? nGranTotal = (from da in dbContab.dAsientos
