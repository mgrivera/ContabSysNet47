...
<%--  --%>
    <div class="notsosmallfont" style="width: 10%; border: 1px solid #C0C0C0; vertical-align: top;
        ...
        <div style="text-align: center;">
            <img id="Filter_img" alt="Para filtrar las cuentas contables que se desea consultar"
                runat="server" src="~/Pictures/filter_16x16.gif" />
            <a href="javascript:PopupWin('BalanceComprobacion_Filter.aspx', 1000, 680)">Definir
       ...
       <%-- function y div para mostrar el progress bar --%>
        ...
        <div style="text-align: center;">
            <img id="Img1" alt="Balance de comprobación" src="../../../Pictures/print_16x16.gif" />
            <asp:HyperLink ID="ComprobantesContables_Reporte_HyperLink" runat="server" CssClass="generalfont"
                NavigateUrl="javascript:PopupWin('BalanceComprobacion_OpcionesReportes.aspx', 1000, 680)">Balance de Comprobación</asp:HyperLink>
            <hr />
        </div>
        ...
        <div style="text-align: center;">
            ...
            <a href="javascript:PopupWin('../../UltimoMesCerradoContable.aspx', 1000, 680)">
                Fechas de último cierre contable</a>
        </div>
                        ...
                        <td id="Td1" runat="server">
                            <table ID="itemPlaceholderContainer" runat="server" border="0" style="border: 1px solid #E6E6E6" class="generalfont" cellspacing="0" rules="none">
                                <tr id="Tr2" runat="server" style="" class="ListViewHeader_Suave generalfont">
                                    <th id="Th1" runat="server" class="padded" style="text-align: left; padding-bottom: 10px;">
                                        Cuenta<br />contable</th>
                                    <th id="Th2" runat="server" class="padded" style="text-align: left; padding-bottom: 10px;">
                                        Descripción</th>
                                    <th id="Th3" runat="server" class="padded" style="text-align: right; padding-bottom: 10px;">
                                        Saldo<br />anterior</th>
