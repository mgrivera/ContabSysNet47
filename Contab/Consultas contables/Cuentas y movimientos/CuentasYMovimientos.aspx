...
<div class="notsosmallfont" style="width: 10%; border: 1px solid #C0C0C0; vertical-align: top;
    ...
    <div style="text-align: center;">
        <img id="Filter_img" alt="Para filtrar las cuentas y moviemientos que se desea consultar"
            runat="server" src="~/Pictures/filter_16x16.gif" />
        <a href="javascript:PopupWin('CuentasYMovimientos_Filter.aspx', 1200, 680)">Definir
    ...
    <div style="text-align: center;">
        <img id="Img1" alt="Mayor general" src="../../../Pictures/print_16x16.gif" />
        <a href="javascript:PopupWin('CuentasYMovimientos_OpcionesReportes.aspx', 1000, 680)" >
            Reporte de cuentas y movimientos
        </a>
    </div>
    ...
    <div style="text-align: center;">
        ...
        <a href="javascript:PopupWin('../../UltimoMesCerradoContable.aspx', 1000, 680)" >
            Fechas de último cierre contable
        </a>
    </div>
    ...
    <div style="text-align: left; float: right; width: 88%;">
                            ...
                            <asp:ListView ID="CuentasContables_ListView" 
                                        ...
                                        <tr id="Tr1" runat="server">
                                            <td id="Td1" runat="server">
                                                <table id="itemPlaceholderContainer" runat="server" border="0" class="ListView smallfont"
                                                    style="background-color: #FFFFFF; padding: 10 5 10 5; border-collapse: collapse;
                                                    ...
                                                    <tr id="Tr2" runat="server" style="" class="ListViewHeader smallfont">
                                                        ...
                                                        <th id="Th11" runat="server" class="padded" style="text-align: left; margin-bottom: 10px;">
                                                            Cuenta<br />contable
                                                        </th>
                                                        ...
                                                        <th id="Th12" runat="server" class="padded" style="text-align: center; margin-bottom: 10px;">
                                                            Cant<br />mvtos
                                                        </th>
                                                    </tr>
                                ...
                                <EmptyDataTemplate>
                                    <table id="Table2" runat="server" style="">
                                        <tr>
                                            <td>
                                                Aplique un filtro para mostrar información.
                                            </td>
                                        </tr>
                                    </table>
                                </EmptyDataTemplate>
                                                ...
                                                <table id="itemPlaceholderContainer" runat="server" border="0" class="ListView smallfont"
                                                    ...
                                                    <tr id="Tr6" runat="server" style="" class="ListViewHeader smallfont">
                                                       <%-- <th id="Th4" runat="server" class="padded" style="text-align: center;">
                                                        ...
                                                        <th id="Th7" runat="server" class="padded" style="text-align: center;">
                                                            Centro<br />Costo
                                                        </th>
                                                        <th id="Th8" runat="server" class="padded" style="text-align: center;">
                                                            Mon<br />orig
                                                        </th>
                                                    ...
                                                    <tr id="Tr8" runat="server" style="" class="ListViewFooter smallfont">
                                                       <%-- <th id="Th4" runat="server" class="padded" style="text-align: center;">
                                                        ...
                                                        <th id="Th16" runat="server" class="padded" style="text-align: left;">
        ...
        <asp:SqlDataSource ID="CuentasContables_Movimientos_SqlDataSource" 
            ...
            SelectCommand = 
                "Select Asientos.Numero As Comprobante,
