<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage_Simple.master" CodeBehind="CierresBancariosEfectuados.aspx.cs" Inherits="ContabSysNetWeb.Bancos.CierresBancariosEfectuados" %>
...
<div>
    <h4>Bancos&nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;Ultimo mes cerrado para las compañías del sistema</h4>
   <asp:ListView ID="ListView1" runat="server" DataSourceID="SqlDataSource1">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT MesesDelAnoFiscal.NombreMes, UltimoMesCerrado.Ano, UltimoMesCerrado.UltAct, Companias.Nombre AS NombreCiaContab FROM UltimoMesCerrado INNER JOIN MesesDelAnoFiscal ON UltimoMesCerrado.Cia = MesesDelAnoFiscal.Cia AND UltimoMesCerrado.Mes = MesesDelAnoFiscal.Mes INNER JOIN Companias ON MesesDelAnoFiscal.Cia = Companias.Numero">
    </asp:SqlDataSource>
</div>
