...
<asp:Content ID="Content1" ContentPlaceHolderID="PanelCentral_ContentPlaceHolder" runat="Server">
    ...
    <div class="notsosmallfont" style="width: 10%; border: 1px solid #C0C0C0; vertical-align: top; background-color: #F7F7F7; float: left; text-align: center;">
        ...
        <a href="javascript:PopupWin('Bancos_ConsultaDisponibilidad_Filter.aspx', 1200, 680)">Definir y aplicar<br />un filtro</a><br />
        <i class="fas fa-filter fa-2x" style="margin-top: 5px;"></i>

        <hr />

        <a href="javascript:PopupWin('../../CierresBancariosEfectuados.aspx', 1000, 680)">Consulta de <br /> cierres de compañías</a><br />
        <i class="fas fa-desktop fa-2x" style="margin-top: 5px;"></i>

        <hr />

        <a href="javascript:PopupWin('MontosRestringidos_Consulta.aspx', 1000, 680)">Consulta de montos restringidos <br /> y cheques no entregados</a><br />
        <i class="fas fa-desktop fa-2x" style="margin-top: 5px;"></i>

        <hr />

        <a href="javascript:PopupWin('Bancos_ConsultaDisponibilidad_OpcionesReportes.aspx', 1000, 680)">Reporte</a><br />
        <i class="fas fa-print fa-2x" style="margin-top: 5px;"></i>

        <hr />

        <a href="../../../ReportViewer.aspx?rpt=disponibilidad_resumen" target="_blank">Reporte<br />(resumido)</a><br />
        <i class="fas fa-print fa-2x" style="margin-top: 5px;"></i>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <span id="ErrMessage_Span" 
                      runat="server" class="errmessage errmessage_background generalfont"
                      style="display: block;">
                </span>

                <cc1:TabContainer ID="ConsultaDisponibilidad_TabContainer" 
                                  runat="server" 
                                  ActiveTabIndex="0"
                    ...
                    <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="Disponibilidad">
                        <ContentTemplate>
                            <h5>Disponibilidad de cuentas bancarias al <asp:Label ID="FechaDisponibilidadAl_Label" runat="server"></asp:Label></h5>
