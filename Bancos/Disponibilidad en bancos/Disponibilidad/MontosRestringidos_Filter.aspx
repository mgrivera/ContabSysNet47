             ...
             <ContentTemplate>
                 ...
                 <table cellspacing="10px" class="notsosmallfont">
                     <tr>
                         ...
                         <td>
                             <asp:TextBox ID="Sql_DisponibilidadMontosRestringidos_Fecha_Date" runat="server" TextMode="Date" Width="125px" />
                         </td>
                         <td>Suspendida: 
                         </td>
                         <td>
                     ...
                     <tr>
                         ...
                         <td>
                             <asp:TextBox ID="Sql_DisponibilidadMontosRestringidos_DesactivarEl_Date" runat="server" TextMode="Date" Width="125px" />
                         </td>
                     </tr>
                 </table>
        ...
        <ContentTemplate>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <asp:ListBox ID="Sql_Monedas_Moneda_Numeric" 
                                     runat="server"
                    ...
                    <td>
                        <asp:ListBox ID="Sql_DisponibilidadMontosRestringidos_CuentaBancaria_Numeric" 
                                     runat="server"
            ...
            <asp:SqlDataSource ID="Monedas_SqlDataSource" 
                               runat="server" 
