...
{
    public class RetencionesIvaReportItem
    {
        ...
        public List<RetencionesIvaReportItem> Get_RetencionesIvaReportItem()
        {
            List<RetencionesIvaReportItem> list = new List<RetencionesIvaReportItem>();
            return list;
        }
    }
